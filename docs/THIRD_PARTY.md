...
Service icons identify the connected products; Codester is not affiliated with their owners. Trademarks remain the property of their respective owners.

- Dagster icon: `js_modules/app-oss/public/favicon.svg` from [dagster-io/dagster](https://github.com/dagster-io/dagster), Apache-2.0.
